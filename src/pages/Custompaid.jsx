...
const Custompaid = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (amountFormatNum < 20 || amountFormatNum > amountFromLoanNum) {
      ...
      }).format(amountFormatNum);
      const message = [
        {
          type: "text",
          text: `ชำระระบุจำนวน > ${contractNo} > ${amountFormat}`,
        },
      ];
    ...
    <>
      ...
      <div className="body">
        <div className="container">
          ...
          <h6 className="text-form">
            ค่างวดเต็มงวด{" "}
            <span className="amount-inline">{amountFromLoan}</span> บาท
          </h6>
      ...
      >
        ...
        <Modal.Footer>
          <Button variant="primary" onClick={handleCloseShowModalInputIsNull}>
            ปิด
          </Button>
        </Modal.Footer>
      </Modal>
          ...
          <div className="row-error">
            ...
            <div className="col-9">
              ...
              <div className="col-9-p">
                จำนวนเงินต้องไม่น้อยกว่า 20 บาท และ ไม่มากกว่า {amountFromLoan}{" "}
                บาท
              </div>
            </div>
          </div>
      ...
      >
        ...
        <Modal.Footer>
          <Button variant="primary" onClick={handleCloseShowModalInputConfirm}>
            แก้ไข
          </Button>
          <Button variant="primary" onClick={handleCloseShowModalInputConfirm}>
            ยืนยัน
